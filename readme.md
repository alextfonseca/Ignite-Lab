...
<img src="./src/assets/project.png" alt="Imagem do projeto">

> Aplicação desenvolvida no Ignite Lab utilizando React, Vite, Typescript, graphQL, GraphCMS, Apollo e tailwind.
...
```bash
$ git clone https://github.com/alextfonseca/Ignite-Lab.git
$ cd Ignite-Lab
$ yarn / npm i
...
# <a href="https://ignite-lab-sandy.vercel.app/">Acesse o projeto</a>
